...
thispid=$(sudo docker run --gpus device=1 --network=host --name=pyrapose_gpu_1 -t -d -v ~/data/train_data/CIT:/PyraPose/data -v ~/data/Meshes:/PyraPose/Meshes pyrapose_gpu_1)
