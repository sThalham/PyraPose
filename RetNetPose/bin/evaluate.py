...
def main(args=None):
    ...
    if args.dataset_type == 'coco':
        ...
        rec, pre, xyd, zd, rotd = evaluate_linemod(generator, model, args.score_threshold)
        print('evaluate::mean recall: ', rec, '%')
        print('evaluate::mean precision: ', pre, '%')
        print('evaluate::mean rotation difference: ', xyd, 'm')
        print('evaluate::mean rotation difference: ', zd, 'm')
