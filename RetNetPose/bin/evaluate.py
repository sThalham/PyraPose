...
def main(args=None):
    ...
    if args.dataset_type == 'coco':
        ...
        rec, pre, xyd, zd, rotd, l5cm, l5deg = evaluate_linemod(generator, model, args.score_threshold)
        print('evaluate::mean recall: ', rec, '%')
        print('evaluate::mean precision: ', pre, '%')
        print('evaluate::mean translation difference: ', xyd, 'm')
        print('evaluate::mean depth difference: ', zd, 'm')
