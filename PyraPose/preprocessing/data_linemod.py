...
'''
def LinemodGenerator(data_dir='/home/stefan/data/train_data/linemod_PBR_BOP', set_name='train',
                     transform_generator=None, self_dir='val', batch_size=8, image_min_side=480, image_max_side=640):
    def _isArrayLike(obj):
        return hasattr(obj, '__iter__') and hasattr(obj, '__len__')
